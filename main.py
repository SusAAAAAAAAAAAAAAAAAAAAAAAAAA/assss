...
@tree.command(name='mines', description='Predictor Mine')
async def mines(interaction: discord.Interaction, tile_amt: int, round_id: str):
    ...
    if len(round_id) == 36:
        ...
        em.set_footer(text='Free Predictor At .gg/JSYDz4w9HB')
...
client.run('MTIwNjIxODc0OTkyNTkyNDg3NA.GUlZKJ.ln4FYDrXCzVAr_sv-ENUiijKJbCLyLtQQ14qig')
